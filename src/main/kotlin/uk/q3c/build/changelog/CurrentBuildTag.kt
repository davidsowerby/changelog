 ...
 */
class CurrentBuildTag(commit: GitCommit, tagName: String) : Tag(tagName, commit.commitDate, commit.commitDate, commit.committer, "Pseudo tag on latest commit", commit, TagType.PSEUDO) {
